        ...
        <div className='w-full h-full bg-cartBg rounded-t-[2rem] flex flex-col'>
            ...
            <div className='w-full h-340 md:h-42 px-6 py-10 flex flex-col gap-3 overflow-y-scroll scrollbar-none'>
                ...
                <div className='w-full p-1 px-2 rounded-lg bg-cartItem flex items-center gap-2'>
                    <img src="https://firebasestorage.googleapis.com/v0/b/restaurantapp-1e5c0.firebasestorage.app/o/Images%2F1735419025776-i1.png?alt=media&token=4239a776-3f32-4f43-990a-0a54bea3ca97" className='w-20 h-20 max-w-[60px] rounded-full object-contain' alt="" />
                    {/* Name Section*/}
