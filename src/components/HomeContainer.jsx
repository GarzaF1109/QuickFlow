...
const HomeContainer = () => {
  return (
    ...
    <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat eum quam cum? Dolores repudiandae in porro. Quisquam suscipit eos nemo ipsa voluptatum ipsam velit placeat, eveniet, illo, distinctio hic voluptates?</p>
